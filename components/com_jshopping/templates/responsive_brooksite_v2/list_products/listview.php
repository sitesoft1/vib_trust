...
<div class="product productitem_<?php print $product->product_id;?> row list-row list-product-caption">
    <div class = "<?php print $prefix?>4 image">
    ...
    <div class="<?php print $prefix?>3">
        <div class="name">
            ...
            <?php if(!empty($country_name) and !empty($city_name)){ ?>
                <div style="font-size: 14px; margin-top: -10px;"><small><?php echo $country_name; ?>, г. <?php echo $city_name; ?></small></div>
            <?php } ?>
        </div>
    ...
    <div class="<?php print $prefix?>2"><!--START BLOCK 3 FOR LISTVIEW-->   
    ...
    <div class="<?php print $prefix?>3"><!--START BLOCK 4 FOR LISTVIEW--> 
    <div class="buttons">
        <?php print $product->_tmp_var_before_buy_1;?>
        <?php print $product->_tmp_var_before_buy_2;?>
        <?php print $product->_tmp_var_count_buttons;?>
